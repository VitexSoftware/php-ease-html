...
**Purpose**: ![EasePHP Framework HTML Logo](https://raw.githubusercontent.com/VitexSoftware/ease-html/master/project-logo.png "Project Logo")
**Status**: Active
**Repository**: git@github.com:VitexSoftware/php-ease-html.git
...
git clone git@github.com:VitexSoftware/php-ease-html.git
cd php-vitexsoftware-ease-html
